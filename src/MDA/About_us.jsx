                ...
                <Row className="align-items-center g-4">
                    <Col xs={12} md={6}>
                        ...
                        <div className="btn2 mt-4">
                            <span as={Link} to="/About_us">Contact Now <img style={{ height: '40px', backgroundColor: 'gray', borderRadius: '100%', padding: '10px' }} src="https://www.staragroindustry.com/public/front_assets/images/right-arrow-2.png" alt="" /></span>
                        </div>
                    </Col>
